...
var __p=[],print=function(){__p.push.apply(__p,arguments);};with(obj||{}){__p.push('<a href="/">home</a>\n<h2>', story.title ,'</h2>\n<p>', story.content ,'</p>');}return __p.join('');
}(data, _)};
...
function(app, Backbone) {
  ...
  console.log('in Example', Example);
  return Example;
...
function(app, $, Backbone, Masseuse, Example, Story) {
  ...
  */
  ...
  //$(document).on(mobileTapEvent, "a:not([data-bypass])", function(evt) {
    ...
    console.log('inside ontouchstart');
    ...
    console.log(href, protocol, href2, protocol2);
